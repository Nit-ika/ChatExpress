    ...
    <form action='logoutSuccess.htm' method='POST'>
        ...
        <c:set var="qid" value="${ques.qid}"/>
                            ...
                            <tr>
                                ...
                                <td>${ques.datePost}</td>
                                <td>
                                    <form action="ans.htm" method="POST">
                            <input type='hidden' id='empId' name="empId" value="${EmpId}"/>                                 
                            <input type='hidden' id='quesId' name="quesId" value="${ques.qid}"/>
                            <input type="submit" name="action" value="View Answers" />
                        </form>
                                </td>
                            </tr>
                        ...
                        <form action="PostQues.htm" method="POST">
                            <input type='hidden' id='empId' name="empId" value="${EmpId}"/>
                            Post Your Questions here:<br/><br/>
